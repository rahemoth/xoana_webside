          ...
          <div>
            <div className="sticky top-24 rounded-2xl bg-zinc-50 p-6 dark:bg-zinc-900">
              ...
              <button
                ...
                className="mt-6 flex w-full items-center justify-center gap-2 rounded-2xl bg-zinc-900 px-6 py-4 font-semibold text-white transition-all hover:bg-zinc-700 disabled:opacity-50 dark:bg-white dark:text-zinc-900"
              >
